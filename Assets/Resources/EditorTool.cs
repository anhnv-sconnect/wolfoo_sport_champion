...
public class SceneTools : Editor
{
    ...
    public static string LoadScenePath = "Assets/Game/Scenes/Loading Scene.unity";
    public static string HomeScenePath = "Assets/Game/Scenes/Home Scene.unity";
    public static string GameScenePath = "Assets/Game/Scenes/Gameplay Scene.unity";
